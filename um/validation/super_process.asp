...
dim vmeters, byear, bperiod, building, pid, post, yscroll
...
if checkSuperval(byear, bperiod, building) then
	...
	cmd.Parameters.Append prm
	Set prm = cmd.CreateParameter("post", adInteger, adParamInput)
	cmd.Parameters.Append prm
