...
<%
dim pid, building, byear, utility
...
{	var frm = document.forms['form1'];
	var newhref = "validation_select.asp?pid="+frm.pid.value;
	document.location.href=newhref;
}

function loadbuilding()
{	var frm = document.forms['form1'];
	var newhref = "validation_select.asp?pid="+frm.pid.value+"&building="+frm.building.value;
	document.location.href=newhref;
}

function loadyear()
{	var frm = document.forms['form1'];
	var newhref = "validation_select.asp?pid="+frm.pid.value+"&building="+frm.building.value+"&byear="+frm.byear.value;
	document.location.href=newhref;
}
...
{	var frm = document.forms['form1'];
	...
	{	var newhref = "bill_validation.asp?pid="+frm.pid.value+"&building="+frm.building.value+"&byear="+frm.byear.value+"&bperiod="+frm.bperiod.value;
...
if trim(byear)<>"" then%>
	...
	<%rst1.open "SELECT Distinct BillPeriod FROM BillYrPeriod WHERE BldgNum='"&building&"' and BillYear=" & trim(byear) & " and utility = '" & utility & "'", cnn1
	do until rst1.eof
...
<iframe src="../blank.htm" name="mainval" id="mainval" width="100%" height="100%" marginwidth="0" marginheight="0" style="background-color: White;"></iframe>
</body>
</html>
