...
cmd1.CommandText = "select * ,datediff(day,datestart,dateend)as difference from tblbillbyperiod where ypid=" & ypid & " order by tenantname"
cmd1.CommandType = 1
    ...
    <td height="485" valign="top">
      ...
      <table width="80%" border="0" align="center" bordercolor="#FFFFFF" cellspacing="0">
        <tr bgcolor="#CCCCCC"> 
		  ...
		  <td width="9%"> 
            <div align="right"><font face="Arial, Helvetica, sans-serif" size="1">READINGS</font></div>
          </td>
		  <td width="6%"> </td>
          <td width="9%"> 
...
rawp=rst1("prevkwh")/rst1("multiplier")
rawc=rst1("currentkwh")/rst1("multiplier")
tot_onpeak = 0
tot_offpeak=0
tot_kwhused=0
tot_demand_p=0
...
%>
        <tr> 
          ...
          <td width="10%" height="1%" align="right" bordercolor="#FFFFFF">&nbsp;</td>
          <td width="12%" height="1%" align="right" bordercolor="#FFFFFF">&nbsp;</td>
		  <td width="5%" height="1%" align="right" bordercolor="#FFFFFF">&nbsp;</td>
          <td width="6%" height="1%" align="right" bordercolor="#FFFFFF"> 
            <div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%=rst1("Meternum")%></font></div>
          </td>
		  <td width="7%" height="1%" align="center" bordercolor="#FFFFFF"> 
          ...
          <td width="9%" height="1%" align="center" bordercolor="#FFFFFF"> 
            ...
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(rawp,0)%></font>
            <% else%>
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(rst1("rawprevious"),0)%><%end if%></font> 
          </td>
		  <td width="6%" height="1%" align="center" bordercolor="#FFFFFF"> 
            <%if  rst1("rawcurrent")=0 then %>
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(rawc,0)%></font>
            <% else%>
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(rst1("rawcurrent"),0)%><%end if %> 
              </font> 
          </td>
		  <td width="9%" height="1%" align="center" bordercolor="#FFFFFF"> 
          ...
          <td width="11%" height="1%" align="center" bordercolor="#FFFFFF"> 
...
%>
        <tr> 
          ...
          <td width="10%" height="1%" align="center" bordercolor="#FFFFFF">&nbsp;</td>
          <td width="12%" height="1%" align="center" bordercolor="#FFFFFF">&nbsp;</td>
		  <td width="5%" height="1%" align="center" bordercolor="#FFFFFF">&nbsp;</td>
          <td width="6%" height="1%" align="center" bgcolor="#CCCCCC"> 
            <p align="right">&nbsp; 
          </td>
		  <td width="7%" height="1%" align="center" bgcolor="#CCCCCC"> </td>
          ...
          <td width="7%" height="1%" align="center" bgcolor="#CCCCCC"> 
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(tot_kwhused,0)%> 
              </font> 
          </td>
          <td width="11%" height="1%" align="center" bgcolor="#CCCCCC"> 
      ...
      <table width="80%" border="0" align="center" bordercolor="#FFFFFF" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="13%" bgcolor="#CCCCCC"> 
            <div align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=FormatCurrency((rst2("energy")+rst2("demand")+rst2("Addonfee")+((rst2("energy")+rst2("demand")+rst2("Addonfee"))* rst2("Adminfee"))),2)%></font></div>
          </td>
        </tr>
        <tr> 
          <td width="2%">&nbsp;</td>
