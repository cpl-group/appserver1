...
'if login = "georgen" then
	...
	'if isempty(Request.form("login")) then
		...
		strsql = "SELECT distinct * from employees where login='" & Request.Form("login") & "'"
		...
		if not rst1.eof then
			...
			Else
				...
				rst1.close		
				strsql = "SELECT distinct * from employees where login='" & Request.Form("login") & "' and password='" & Request.Form("password") & "'"
				rst1.Open strsql, cnn1, 0, 1, 1
