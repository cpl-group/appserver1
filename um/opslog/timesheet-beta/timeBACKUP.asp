...
function setUp(name){
	...
	//window.name = "opener"
	document.tsbottom.location = temp;
}
...
<table border=0 cellpadding="3" cellspacing="0" width="100%">
	...
	<tr> 
		<td style="border-top:1px solid #ffffff;border-bottom:1px solid #999999;">
			...
			<button name="Submit" value="Set Up Week" onClick="setUp(document.form1.name.value)" 
			...
			<button name="submit1" value="Submit Time Sheet" onClick="timesheetjob( name.value,start.value,end1.value)" 
