          ...
          <tr> 
            ...
            <td height="2"> 
              <div align="right"><i><b><font face="Arial, Helvetica, sans-serif" color="#FFFFFF">
				...
				%>
				<input type="button" name="Button3" value="Sumbit PO for Review" onClick="processpo(id1.value,this.value,ship_amt.value)">
				<% else
				%>
				<input type="button" name="Button3" value="Withdraw Submitted PO" onClick="processpo(id1.value,this.value)">
				<%
				end if%>
