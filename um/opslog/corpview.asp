...
function fillup(item){
	document.location="corpview.asp?item="+item
}
function check(v){
...
function Search(item, c){
	if(item=="job" && isNaN(c)){
		...
		document.frames.invoice.location="corpinvoice.asp?item="+item+"&date="+c
	}
}
...
%>
  ...
  <p>
    <input type="button" name="Submit2" value="Invoices" onclick='javascript:document.frames.invoice.location="corpinvoice.asp"'>
  </p>
...
<IFRAME name="invoice" width="100%" height="100%" src="corpinvoice.asp" scrolling="auto" marginwidth="0" marginheight="0" ></IFRAME> 
</body>
</html>
