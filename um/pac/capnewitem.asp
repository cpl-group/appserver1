  ...
  <div align="center">
    <table width="100%">
      <tr> 
        <td width="40%">&nbsp;</td>
        <td width="20%"> 
          <div align="center"><font face="Arial, Helvetica, sans-serif" color="#000000"><b><%=val%></b></font></div>
        </td>
        <td width="40%">&nbsp;</td>
      </tr>
      <tr> 
        <div align="center"> 
          <td width="40%"> 
            <div align="left"><b><font face="Arial, Helvetica, sans-serif"> Assigned</font></b></div>
          </td>
          <td width="20%"><font face="Arial, Helvetica, sans-serif" color="#000000"><b></b></font></td>
          <td width="40%"> 
            <div align="right"><b><font face="Arial, Helvetica, sans-serif">Available</font></b></div>
          </td>
        </div>
      </tr>
      <tr> 
