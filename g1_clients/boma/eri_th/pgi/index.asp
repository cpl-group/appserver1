...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" align="center">
  ...
  <tr> 
    <td align="center"><object classid ="clsid:B2BE75F3-9197-11CF-ABF4-08000996E931" codebase = "whip.cab#version=-1,-1,-1,-1" height=600 width=700>
<param name="Filename" value="<%=Request.QueryString("pgi")%>">
<embed name=thanks src="<%=Request.QueryString("pgi")%>" pluginspage="http://www.autodesk.com/whip" height=100% width=100%>
</object>
</td>
  </tr>
</table>
