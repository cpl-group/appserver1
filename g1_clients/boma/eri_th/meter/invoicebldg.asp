...
cmd1.CommandText = "select * from tblbillbyperiod where ypid=" & ypid
cmd1.CommandType = 1
...
%>
      ...
      <table width="80%" border="0" align="center" bordercolor="#FFFFFF" cellspacing="0">
        ...
        <tr bordercolor="#FFFFFF" bgcolor="#CCCCCC"> 
          ...
          <td width="15%"> 
            <div align="right"><font face="Arial, Helvetica, sans-serif" size="1">METER</font></div>
          </td>
          <td width="15%"> 
          ...
          <td width="12%"> 
            <div align="right"><font face="Arial, Helvetica, sans-serif" size="1">KWH</font></div>
          </td>
          <td width="30%"> 
...
%>
        <tr bordercolor="#FFFFFF"> 
          ...
          <td width="15%" height="1%" align="right" bordercolor="#FFFFFF"> 
            <div align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=rst1("Meternum")%></font></div>
          </td>
...
%>
        <tr bordercolor="#FFFFFF"> 
          ...
          <td width="15%" height="1%" align="center" bgcolor="#CCCCCC" bordercolor="#FFFFFF"> 
            <p align="right"><font face="Arial, Helvetica, sans-serif" size="1">Totals 
              </font> 
          </td>
      ...
      <table width="80%" border="0" align="center" bordercolor="#FFFFFF" cellspacing="0">
        ...
        <tr> 
          ...
          <td width="13%" bordercolor="#FFFFFF"> 
            <div align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=FormatCurrency((rst2("Adminfee")*(rst2("energy")+rst2("demand")+rst2("Addonfee")+((rst2("energy")+rst2("demand")+rst2("Addonfee"))* rst2("Adminfee")))),2)%></font></div>
          </td>
        </tr>
        <tr> 
          <td width="2%">&nbsp;</td>
