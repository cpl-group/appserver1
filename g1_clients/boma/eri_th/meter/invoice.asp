...
<body bgcolor="#FFFFFF" text="#000000" onload="javascript:alert('Right Click On the Bill and Select Print to print this Bill')">
...
cmd1.CommandText = "select *, datediff(day,datestart, dateend) as difference  from tblbillbyperiod where leaseutilityid=" & leaseid & " and ypid=" & ypid
cmd1.CommandType = 1
...
%>
        <tr valign="bottom"> 
          ...
          <td width="9%" height="1%" align="center" bordercolor="#FFFFFF"> 
            ...
            &nbsp; 
            <% else%>
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(rst1("rawprevious"),0)%></font> 
              <%end if%>
          </td>
          ...
          <td width="9%" height="1%" align="center" bordercolor="#FFFFFF"> 
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(rst1("used"),0)%></font> 
          </td>
          <td width="12%" height="1%" align="center" bordercolor="#FFFFFF"> 
  ...
  <tr>
    <td valign="top"> 
      ...
      <table width="80%" border="0" align="center">
        ...
        <tr> 
          <td><b><font size="1" face="Arial, Helvetica, sans-serif">Demo tenant</font></b></td>
          <td><b><font size="1" face="Arial, Helvetica, sans-serif">Demo Building</font></b></td>
        </tr>
        <tr> 
          <td><b><font size="1" face="Arial, Helvetica, sans-serif">123 Madison 
            Ave </font> </b></td>
          <td><b><font size="1" face="Arial, Helvetica, sans-serif">123 Madison 
            Ave </font> </b></td>
        </tr>
