...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#000000">
  <tr>
    ...
    <td width="46%" bgcolor="#000000" align="right"><b><font face="Arial" size="3"><a href="javascript:document.location='../lmp/opt_accthist.asp?b=<%=b%>&m=<%=m%>&luid=<%=leaseid%>'" style="text-decoration:none;color:white" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'white'"><font size="2">Return To Billing History</font></a></font></b></td>
  </tr>
</table>
