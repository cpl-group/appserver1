...
function setDate() {
    ...
    this.inDate      = opener.document.forms[0].d.value;
...
var b= document.forms.calControl.b.value
var m= document.forms.calControl.m.value
var s= document.forms.calControl.s.value
var e= document.forms.calControl.e.value
var l= document.forms.calControl.luid.value
var lmp = opener.document.forms[0].lmp.value
	...
	opener.document.forms[0].pd.value = pd
 	...
 	var temp="https://appserver1.genergy.com/eri_th/lmp/lmpload.asp?m="+m+"&d="+d+"&b="+b+"&s="+s+"&e="+e+"&luid="+l+"&lmp="+lmp
