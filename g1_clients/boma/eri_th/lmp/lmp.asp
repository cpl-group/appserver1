...
<div id="lmptabs" style="visibility:visible;position:relative;left:0;top:0;">
	...
	<tr>
		...
		<td id="tab3" width="5%" style="background-color:#CCCCCC">&nbsp;<a href="javascript:loadcalendar()" onClick="settabs(document.all['tab3']);" onMouseOver="this.style.color='black';" onMouseOut="this.style.color= 'white';" style="color:white">Calendar</a>&nbsp;</td>
		<td  width="85%" align="right">&nbsp;</td>
	</tr></table>
</div>

<table width="100%" border="0" cellspacing="0" cellpadding="0" height="277" align="center">
<tr><td width="100%" height="330"><iframe src="<%=IFrame1%>" name="lmp" id="lmp" width="100%" height="100%" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
</table>
