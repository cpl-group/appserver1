...
<tr>
  <td align="center"><img src="PlantAnalysisInOut.asp?groupname=<%=groupname%>&startdate=<%=tmonth%>/<%=tday%>/<%=tyear%>&enddate=<%=fmonth%>/<%=fday%>/<%=fyear%>&patrend=<%=patrend%>&pascatter=<%=pascatter%>" width="600" height="310"></td>
</tr>
<tr>
