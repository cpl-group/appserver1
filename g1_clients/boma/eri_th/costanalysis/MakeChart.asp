...
function findpeak()
	...
	for i = 1 to 12
		dim tempExp, tempRev
		tempExp = ArrDataSeriesERI(i)+ArrDataSeriesUnreportedExp(i)
		if tempExp>peak then peak = tempExp
		tempRev = ArrDataSeriesSubMetered(i)+ArrDataSeriesExpenses(i)+ArrDataSeriesUnreportedRev(i)+ArrDataSeriesMac(i)+ArrDataSeriesPLP(i)
