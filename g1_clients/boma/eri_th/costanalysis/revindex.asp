...
dim IFrame1, IFrame2
IFrame1 = "revChartLoad.asp?b="& b &"&pid="& pid &"&utype=Electricity&date1="& date1
IFrame2 = "options.asp?b="& b &"&pid="& pid &"&utype=Electricity&date1="& date1
%>
<HTML>
...
{	var date1 = document.forms['form1'].date1.value;
	var date2 = document.forms['form1'].date2.value;
	var utype = document.forms['form1'].utype.value;
	document.frames['chart'].document.location.href = 'revChartLoad.asp?b=<%=b%>&utype='+utype+'&date1='+date1+'&date2='+date2;
	...
	{	document.frames['options'].document.location.href = 'monthlyDetails.asp?b=<%=b%>&utype='+utype+'&date1='+date1+'&date2='+date2;
...
{	var date1 = document.forms['form1'].date1.value;
	var date2 = document.forms['form1'].date2.value;
	var utype = document.forms['form1'].utype.value;
	document.frames['options'].document.location.href = 'options.asp?b=<%=b%>&pid=<%=pid%>&utype='+utype+'&date1='+date1+'&date2='+date2;
}
...
<!-- 	<td id="tab5" width="2%" style="background-color:#CCCCCC" onclick="settabs(this);storedPreferenceHottab=this">&nbsp;<a href="javascript:document.forms['form1'].utype.value='gas';loadchart()" onMouseOver="this.style.color='black';" onMouseOut="this.style.color= 'white';">Gas</a>&nbsp;</td> -->
	<td id="tab3" width="19%" style="background-color:#CCCCCC">&nbsp;<a href="preferences.asp" onclick="settabs(document.all['tab3']);" target="chart" onMouseOver="this.style.color='black';" onMouseOut="this.style.color= 'white';">View 
      Preferences</a>&nbsp;&nbsp;&nbsp;</td>
