...
if trim(request("uname"))<> "" then 
	...
	%>
	<script>
	document.location = "<%=session("initialpath")%>"
	//window.close()
	 </script>
	<%
	else
...
<body BGCOLOR="#336699" background="/images/login/login-blue-2.gif" LINK="#0000CC" VLINK="#0000CC" TEXT="#000000" onload="document.forms['FrontPage_Form1'].uname.focus();preloadImg();">
  ...
  <tr valign="bottom" height="7">
    ...
    <td align="right"><img src="/images/login/cr_eee-blue2-se.gif" alt="" width="10" height="8" border="0"></td>
        ...
        <p><font size="2" face="Arial, Helvetica, sans-serif"><br><span class="standard" style="font-family:Arial,Helvetica,sans-serif;font-size:8pt;color:#ffffff""> 
          <b>NOTE:</b> gEnergyOne applications require <a href="http://www.microsoft.com/windows/ie/" target="new" style="color:#99ff99">Internet Explorer +6.0</a> </font></p>
