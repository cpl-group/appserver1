...
AC_AX_RunContent( 'classid','clsid:A662DA7E-CCB7-4743-B71A-D817F6D575DF','codebase','http://www.autodesk.com/global/dwfviewer/installer/DwfViewerSetup.cab','height','100%','width','100%','viewastext','VIEWASTEXT','id','Object1','src','<%=Request.QueryString("pgi")%>' ); //end AC code
</script><noscript><object classid ="clsid:A662DA7E-CCB7-4743-B71A-D817F6D575DF" 
		codebase = "http://www.autodesk.com/global/dwfviewer/installer/DwfViewerSetup.cab" height=600 width=100% VIEWASTEXT ID="Object1">
