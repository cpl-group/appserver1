...
cnn1.Open getConnect(0,bldg1,"engineering")
...
<div align="center">
 <center>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" bordercolor="#333333">
      <tr bgcolor="#0099FF"> 
        <td width="11%"><b><font size="1" face="Arial, Helvetica, sans-serif"><%=bldgStreet%> 
          (<%=Bldg%>)</font></b></td>
        <td width="26%"><b><font size="1" face="Arial, Helvetica, sans-serif"><%=bldgname%></font></b></td>
        <td width="63%">
          <div align="right"><b><img src="../../images/lock.gif" width="16" height="17"></b></div>
        </td>
      </tr>
      <tr>
