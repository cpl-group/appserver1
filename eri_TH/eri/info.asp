...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
  <tr bgcolor="#999999"> 
    <td width="10%" colspan="10"><b><font face="Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><i> No History Available for Tenant # <%=Request("qcatnr")%></i></font></b></td>
  </tr>
</table>
<%else%>
<body bgcolor="#0099FF">
