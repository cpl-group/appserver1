...
cnn1.Open application("CnnStr_eri_data")
...
sql="SELECT SUM(Tenant_info.CCY) AS Tot_Year, SUM(Tenant_info.ccm) " &_
    ...
    "Buildings.BldgNum = Tenant_info.Bldg_no WHERE (Buildings.Owner_id = N'TH') AND " &_ 
...
<table align="center" border="0" width="815" cellpadding="3" cellspacing="0" height="102">
<tr>
<td align="center" width="421" rowspan="2" height="46">
<h1><font size="5">Trizec Hahn Office Properties</font></h1>
</td>
<td align="left" width="206" bordercolor="#008000" height="20">Yearly ERI Revenue</td>
<td align="right" width="80" height="20">

<p align="right"><b><%=FormatCurrency(rsCat1("tot_year"),0)%></b></td>
</tr>
<tr>
<td align="left" width="206" height="20">Monthly ERI Revenue</td>
<td align="right" width="80" height="20">

<p align="right"><b><%=formatcurrency(rsCat1("tot_month"),0)%></b></td>
</tr>
<tr>
<td align="center" width="421" rowspan="2" height="44">
<h2><font size="4">Electric Rent Inclusion Management</font></h2>
</td>
<td align="left" width="206" height="20">ERI sqft</td>
<td align="right" width="80" height="20">

<p align="right"><b><%=formatnumber(rsCat1("tot_sqft"),0)%></b></td>
</tr>
<tr>
<td align="left" width="206" height="18">Average ERI $/sqft</td>
<td align="right" width="80" height="18">
...
<th align="center" width="10%">ERI Leases</th>
...
sql = "SELECT Buildings.BldgNum, Buildings.Strt, COUNT(Tenant_info.Tenant_no) AS Tot_tenant, " &_ 
    ...
    "Tenant_info ON Buildings.BldgNum = Tenant_info.Bldg_no WHERE (Buildings.Owner_id = N'TH') AND " &_ 
...
<p align="center"><% 
   Response.write "<a href=" & chr(34) & "catalog.asp?" & _
