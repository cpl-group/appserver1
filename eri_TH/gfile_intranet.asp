...
'managepath = "\\\\10.0.7.64" & replace(replace(strPath, "/eri_th/", "/web_folders/"),"/", "\\")
managepath = "\\\\2012dc" & replace(replace(strPath, "/eri_th/", "/web_folders/"),"/", "\\")
...
<table width="100%" border="0" cellspacing="0" cellpadding="3">
  ...
  <tr> 
   ...
   <tr><td></td></tr><tr><td><div align="center"><strong><a href="javascript:openwin('<%=managepath%>',400,300);">Manage This Folder</a></strong>
        <% if trim(Request("sub"))="true" then %>
        <strong> | <a href="./gfile_intranet.asp?clientname=<%=clientname%>&clientdir=<%=prevdir%>&sub=<%=subval%>">Back 
...
For Each objItem In objFolder.SubFolders
	...
	%>
	<tr>
		<td align="left" ><a href="./gfile_intranet.asp?clientname=<%=clientname%>&clientdir=<%=strpath & objItem.Name & "/"%>&sub=true&prevdir=<%=strpath%>"><%= objItem.Name %></a></td>
