<%option explicit
dim pid, cdate, d, cnn, rst, bldglist, numbuildings,bldgarray(), aX, bArray
pid = request("pid")
d = date()
...
bldglist.open sql, cnn, 1,1 
numbuildings = bldglist.recordcount
Redim Bldgarray(numbuildings)
...
<table width="357" border="0">
  <tr>
    <td><p><em><strong><font face="Arial, Helvetica, sans-serif" size="2">NOTE: 
        Default profile shown is the most recent data set . </font></strong></em></p></td>
  </tr>
  <tr> 
    <td width="42%" bgcolor="#000000"><em><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><%=numbuildings%> 
      Buildings are profiled above: </font></strong></em></td>
  </tr><tr><td>
  <div name="meterlist" style="border-width:1; width:357; height:200;overflow:auto" > 
    <table width="100%" border="0">
      <tr> 
        <td> 
          <% For each bArray in bldgarray
	%>
      <tr> 
        <td><font size="1" face="Arial, Helvetica, sans-serif"><%=barray%> 
            </font></td>
      </tr>
      <%  next
	 %></td></tr>
