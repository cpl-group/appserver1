  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td> 
        ...
        <p><font face="Arial, Helvetica, sans-serif"><b>Comparative Electrical 
          Revenue Profile for <%=bldgname%> for <%=year%></b></font> </p>
        </blockquote>
      </td>
      <td> 
        <div align="right"><font face="Arial, Helvetica, sans-serif"><b><a href=<%="revenueprofiledev.asp?bldgNUM=" & bldg & "&year=" & year %>>Page 
          1 </a></b></font> </div>
      </td>
    </tr>
  </table>
<div align="center"> 
  <table width="810" border="1" cellspacing="0" cellpadding="0" bordercolor="#333333" align="center" height="410">
    <tr> 
      <td height="33"> 
        <div align="center"><img src="<%="makechartyrly.asp?bldgNUM=" & bldg & "&year=" & year %>"></div>
      </td>
    </tr>
  </table>
 <%
...
%>
  <p align="center">&nbsp;</p>
  <table width="810" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC">
    <tr> 
