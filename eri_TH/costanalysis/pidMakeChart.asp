...
call getdataSetsPortfolio(date1, pid, utype, "0")', ArrDataSeriesERI, ArrDataSeriesSubMetered, ArrDataSeriesExpenses, ArrDataSeriesUnreportedExp, ArrDataSeriesUnreportedRev, ArrPieRevenue, ArrPieExpenses)
...
for i = 1 to 12
	objChart.AddData ArrDataSeriesExpenses(i), 0, , RGB(255,0,0)
	objChart.AddData ArrDataSeriesUnreportedExp(i)*-1, 1, , RGB(150,0,0)
...
if trim(date2)<>"" then
	...
	for i = 1 to 12
		objChart.AddData ArrDataSeriesExpenses(i), 2,, RGB(255,0,0)
		objChart.AddData ArrDataSeriesUnreportedExp(i), 3,, RGB(150,0,0)
...
function findpeak()
	...
	for i = 1 to 12
		dim tempExp, tempRev
		tempExp = ArrDataSeriesExpenses(i)+ArrDataSeriesUnreportedExp(i)
