...
dim IFrame1, IFrame2
IFrame1 = "pidrevChartLoad.asp?b="& b &"&pid="& pid &"&utype=Electricity&date1="& date1
IFrame2 = "pidoptions.asp?b="& b &"&pid="& pid &"&utype=Electricity&date1="& date1
%>
<HTML>
...
{	var date1 = document.forms['form1'].date1.value;
	...
	alert("Data not available prior to 2002");	
	}
}
...
{	var date1 = document.forms['form1'].date1.value;
	var date2 = document.forms['form1'].date2.value;
	var utype = document.forms['form1'].utype.value;
	document.frames['chart'].document.location.href = 'pidrevChartLoad.asp?pid=<%=pid%>&utype='+utype+'&date1='+date1+'&date2='+date2;
	openLoadBox('loadFrame1');
	var frame2Href = document.frames['options'].document.location.href
	frame2Href = frame2Href.toLowerCase()
	if((frame2Href.indexOf("pidmonthlydetails.asp")!=-1)||(frame2Href.indexOf("breakdownexpense.asp")!=-1)||(frame2Href.indexOf("breakdownsub_eri.asp")!=-1)||(frame2Href.indexOf("breakdownadjustment.asp")!=-1)||(frame2Href.indexOf("BreakdownPLP_mac.asp")!=-1))
	{	document.frames['options'].document.location.href = 'pidmonthlydetails.asp?pid=<%=pid%>&utype='+utype+'&date1='+date1+'&date2='+date2;
...
{	var date1 = document.forms['form1'].date1.value;
	var date2 = document.forms['form1'].date2.value;
	var utype = document.forms['form1'].utype.value;
	document.frames['options'].document.location.href = 'pidoptions.asp?b=<%=b%>&pid=<%=pid%>&utype='+utype+'&date1='+date1+'&date2='+date2;
}
...
<input type="hidden" name="utype" value="Electricity">
</form>
...
<div align="center">&nbsp; <a href="/g1_clients/manual/lmp.htm" style="text-decoration:none;color:white" onMouseOver="this.style.color = 'lightblue'" onMouseOut="this.style.color = 'white'"><img src="../../images/lock.gif" width="16" height="17"></a> 
</div>
<table width="714" border="0" cellspacing="0" cellpadding="0" align="center"  style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; font-weight: bold; text-decoration:none;">
<tr>
<!-- 	<td id="tab1" width="2%" style="background-color:#CCCCCC" onclick="settabs(this);storedPreferenceHottab=this">&nbsp;<a href="javascript:document.forms['form1'].utype.value='all';loadchart()" onMouseOver="this.style.color='black';" onMouseOut="this.style.color='white';">General&nbsp;Expense</a>&nbsp;</td> -->
	<td id="tab2" width="15%" style="background-color:#0099FF">&nbsp;<a href="javascript:loadchart()" onclick="document.forms['form1'].utype.value='Electricity';settabs(document.all['tab2']);storedPreferenceHottab=document.all['tab2']" onMouseOver="this.style.color='black';" onMouseOut="this.style.color='white';">Revenue&nbsp;Profile</a>&nbsp;</td>
...
<!-- 	<td id="tab5" width="2%" style="background-color:#CCCCCC" onclick="settabs(this);storedPreferenceHottab=this">&nbsp;<a href="javascript:document.forms['form1'].utype.value='gas';loadchart()" onMouseOver="this.style.color='black';" onMouseOut="this.style.color= 'white';">Gas</a>&nbsp;</td> -->
	<td id="tab3" width="19%" style="background-color:#CCCCCC">&nbsp;<a href="pidpreferences.asp" onclick="settabs(document.all['tab3']);" target="chart" onMouseOver="this.style.color='black';" onMouseOut="this.style.color= 'white';">View 
      Preferences</a>&nbsp;&nbsp;&nbsp;</td>
	<td  width="66%" align="right">&nbsp;</td>
</tr></table>

<table width="714" border="0" cellspacing="0" cellpadding="0" height="277" align="center">
<tr><td width="687" height="330"><iframe name="chart" id="lmp" style="" width="100%" height="100%" src="<%=IFrame1%>" scrolling="auto" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
</table>
<table width="714" border="0" cellspacing="0" cellpadding="0" align="center" height="290">
