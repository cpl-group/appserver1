...
%>
      <%if pid="vo" then %>
      <p><font color="#FFFFFF"><a href="<%="../revprof/" & b &"/page.htm"%>" target="_blank"><b><font face="Arial, Helvetica, sans-serif" size="2">2000-2001 
