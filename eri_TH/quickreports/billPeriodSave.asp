<%option explicit%>
<% ' 5/27/2008 N.Ambo created ythis asp page to save bill period infromation to the database
'This page was copied from /genergy2/setup/billperiodsave.asp and the redirect url changed to 
'point back to the historicalldataentry page
%>
...
'end if
utype = utility
Response.redirect "historicaldataentry.asp?pid="&pid&"&bldgNum="&bldg&"&utilityid="&utype
%>