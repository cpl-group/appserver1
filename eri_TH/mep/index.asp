...
function pgi(bldg,filename){
	theURL="https://appserver1.genergy.com/eri_th/mep/index.asp?pgi=" + bldg + "/" + filename 
...
<table width="600" border="1" cellspacing="0" cellpadding="0" height="480" align="center">
  <tr> 
    <td> 
		<object classid ="clsid:B2BE75F3-9197-11CF-ABF4-08000996E931" codebase = "whip.cab#version=-1,-1,-1,-1" height=700 width=700>
