...
<%
'N.Ambo modified 6/13/2008 to add special condition when energydetail and demanddetail are equal to "0" from the rescordset rst2 
'response.write("JLL")
dim leaseid, ypid, building, pid, byear, bperiod, utilityid, detailed, meterbreakdown, calcintpeak, SJPproperties, ShowUsageDetails, ShowDemandDetails,onlinereview,totdeliverychrgs, maxmeters, textheader, masterTotal,demo, reject, energydetail, demanddetail
...
'6/16/2007 Added by N. Ambo
' For utilities 3,6, 10 the Sub Total is being calculated by using energydetail which is actually a ntext value. This if statement was added
...
'Do the same for demanddetail which is also a ntext value
if (IsNull(rst2("energydetail")) OR rst2("energydetail")= "0") then 
   energydetail = 0
 ...
 if (IsNull(rst2("demanddetail")) OR rst2("demanddetail")= "0") then 
   demanddetail = 0
   'Response.Write "ENERGY DETAIL:   " & energydetail
   else 
   	demanddetail = rst2("demanddetail")
 end if			
  ...
  <td bgcolor="#eeeeee" valign="top">
	...
	%>
      ...
      <tr bgcolor="#eeeeee">
		...
		%></td>
        <td width="30">&nbsp;</td>
        <td><%=FormatCurrency(demanddetail,6)%></td>
      </tr>
      </table>
    <%case 1, 4%>
	<table border=0 cellpadding="2" cellspacing="0" bgcolor="#eeeeee">
...
<%
 ...
 <% if building <> "2725" then %><td colspan="3">&nbsp;<br><center>If you have any questions about your bill, please call Genergy @ 212-664-7600 ext 105.<br>
