...
<table width="690" border="0" cellpadding="0" cellspacing="0" ID="Table2">
  ...
  <% 
	if (invoiceNum = "") then
	'response.write "no invoicenum<br>"
...
acctnumber=0'rst3("acctnumber")
seqnumber=0'rst3("seqnumber")
leasenumber=0'rst3("leasenumber")
corpStreet=0'rst3("corpStreet")
corpCity=0'rst3("corpCity")&","
corpState=0'rst3("corpState")&","
corpZip=0'rst3("corpZip")
    ...
    <td height="100" width="690"><table width="100%" height="100" border="0" ID="Table4">
      ...
      <tr>
        <td height="50" valign="top"><table width="100%" height="50" border="0" cellpadding="0" cellspacing="0" ID="Table5">
          ...
          <tr>
            <td height="20" valign="top"><font face="Arial" size="2"><b>Address:</b></font></td>
