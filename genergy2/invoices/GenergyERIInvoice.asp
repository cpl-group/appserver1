...
dim buildingwithoutspace

buildingwithoutspace = trim(request("building"))
buildingwithoutspace = replace(buildingwithoutspace," ","%20")
...
<%
  ...
  <% 
    Dim txtcontanct
	txtcontanct="If you have any questions about your bill, please call Genergy @ 212-664-7600 ext 105."
