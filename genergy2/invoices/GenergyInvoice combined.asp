...
dim leaseid, ypid, byear, bperiod, utilityid, detailed, meterbreakdown, calcintpeak, SJPproperties, ShowUsageDetails, ShowDemandDetails,onlinereview,totdeliverychrgs, maxmeters, textheader, masterTotal,demo, reject, energydetail
...
dim desc
dim usageHeader
Dim subTotalDelivery,subTotalSupply


if ( pid = 1171 or building = "2288Atlant" ) and utilityid = 3 then			' H2o Cold Water invoice starts here 
																			' goto line 1544 for genergy invoice
