...
<%
dim leaseid, ypid, building, pid, byear, bperiod, utilityid, detailed, meterbreakdown, calcintpeak, SJPproperties, ShowUsageDetails, ShowDemandDetails,onlinereview,totdeliverychrgs, maxmeters, textheader, masterTotal,demo, reject, totalDue
			...
			case 3, 10, 6
				if meterbreakdown then
					...
					<tr bordercolor="#FFFFFF">
						...
						<!-- kcheng 8/11/2009 requests from Kimberly to remove sub total from water bills because sub totals do not match throught out the bills -->
  ...
  <td bgcolor="#eeeeee" valign="top">
	...
	%>
      ...
      <tr bgcolor="#eeeeee">
		...
		%></td>
        <td width="30">&nbsp;</td>
        <td><%=FormatCurrency(rst2("energydetail"),6)%></td>
      </tr>
      <tr bgcolor="#eeeeee">
        <td><%Select Case Utilityid
				case 3,10
...
case 3, 10, 6		'water utilities%>
  ...
  <% dim beforeTax
    beforeTax = subTotal * cdbl(rst2("taxnonull"))
    totalDue = subTotal + beforeTax %>
  <tr>
...
<%
  ...
  <tr>
   <td colspan="3">&nbsp;<br><center>If you have any questions about your bill, please contact Arlene Blair, MB Real Estate @ 212-809-7777 Ext. 225<br>
