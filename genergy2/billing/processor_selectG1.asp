...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <form name="form1" action="billprocess.asp">
	...
	document.location='processor_selectG1.asp?pid=<%=pid%>&building=<%=building%>&utilityid=<%=utilityid%>&bperiod=<%=bperiod%>&historic=<%if historic then%>false<%else%>true<%end if%>'
...
{	var frm = document.forms['form1'];
	var newhref = "processor_selectG1.asp?pid="+frm.pid.value;
	document.location.href=newhref;
}

function loadbuilding()
{	var frm = document.forms['form1'];
	var newhref = "processor_selectG1.asp?pid="+frm.pid.value+"&building="+frm.building.value;
	document.location.href=newhref;
}

function loadutility()
{	var frm = document.forms['form1'];
	var newhref = "processor_selectG1.asp?pid="+frm.pid.value+"&building="+frm.building.value+"&utilityid="+frm.utilityid.value;
	document.location.href=newhref;
}

function loadperiod()
{	var frm = document.forms['form1'];
	var newhref = "processor_selectG1.asp?pid="+frm.pid.value+"&building="+frm.building.value+"&utilityid="+frm.utilityid.value+"&bperiod="+frm.bperiod.value+"&historic="+frm.historic.value
	document.location.href=newhref;
}
