...
{
	cWin = window.open('/genergy2/billing/processbills.asp?pid=<%=pid%>&byear=<%=byear%>&bperiod=<%=bperiod%>&utilfilter=<%=utilityid%>','Process Bills','width=900,height=1000,resizable=yes, scrollbars=yes')
	cWin.focus();
}
