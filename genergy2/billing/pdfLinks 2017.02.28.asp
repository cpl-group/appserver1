...
End Function
	...
	for i = 1 to maxPageCount
			strFileName	= "D:\WebSites\isabella\genergyonline.com\pdf\" & portfolio & "\" & cbldg & "\" & cbldg & byear & bperiod & utilityid & i & ".pdf"
			absfile = portfolio & "\" & cbldg & "\" & cbldg & byear & bperiod & utilityid & i & ".pdf"
'Response.Write("pdfFileName sought: " + strFileName)		
'response.write objFSO.FileExists(strFileName)
'Response.write CheckRemoteURL("http://pdf.genergyonline.com/pdfMaker/"&absfile)
'response.end
