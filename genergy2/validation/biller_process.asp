...
if checkBillval(byear, bperiod, building) then
	...
	response.redirect "re_index.asp?pid="&pid&"&building="&building&"&byear="&byear&"&bperiod="&bperiod&"&utilityid="&utilityid&"&yscroll="&yscroll&"&mscroll="&mscroll&"&yscroll2="&yscroll2&"&showscroll="&showscroll&"&showscroll2="&showscroll2
end if
