...
<!--page created for G1 console page-->
<!--
BODY {
...
<% if not hideoptions then 
if trim(enflex)<>"" then%>
<tr><td width="687" height="310"><iframe name="dataset" enflex="1" width="100%" height="100%" src="<%=enflex%>" scrolling="auto" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
<%else%>
<tr><td width="687" height="310"><iframe name="dataset" enflex="0" width="100%" height="100%" src="<%=IFrame2%>" scrolling="auto" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
<%end if
end if%>
