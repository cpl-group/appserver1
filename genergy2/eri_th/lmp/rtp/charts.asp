...
<%
dim by, lmpdate,lmpdate1,lmpdate2, bldg, meterid,  rgblist,y,graphtype,region, ratelabel, bldglabel, qrytype,costlabel
...
strsql = "select strt,portfolioid from buildings where bldgnum = '" & bldg &"'"
...
if meterid = "" then 
	strsql = "select meterid from meters where bldgnum = '" & bldg &"' and lmp = 1"
	rs.Open strsql, cnn,0
