...
{	
	...
	var year = d.getYear() + 1900;  //rsm added whole line for IE9
	d = (d.getMonth()+1) + "/" + d.getDate() + "/" + year;
	//d = (d.getMonth()+1) + "/" + d.getDate() + "/" + d.getYear() + 1900;
    return(d);
}
...
{	var startdate = new Date(document.forms[0].startdate.value)
	...
	var year = startdate.getYear() + 1900;  //rsm added 1900 for ie9
...
<% if not hideoptions then 
if trim(enflex)<>"" then%>
<tr><td width="100%" height="310"><iframe name="dataset" enflex="1" width="100%" height="100%" src="<%=enflex%>" scrolling="auto" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
<%else%>
<tr><td width="100%" height="310"><iframe name="dataset" enflex="0" width="100%" height="100%" src="<%=IFrame2%>" scrolling="auto" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
<%end if
end if%>
