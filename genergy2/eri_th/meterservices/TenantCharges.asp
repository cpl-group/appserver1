...
<%	
	...
	objWorkBook.SaveCopyAs("\\2012dc\web_folders\finance\"  & ctime & "TenantCharges.xlsx")
	...
	strFilename = "\\2012dc\web_folders\finance\" & ctime & "TenantCharges.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="http://appserver1.genergy.com/eri_TH/finance/<%=ctime%>TenantCharges.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>TenantCharges.xlsx</b></a> 
	</p>
	<%
	Else
	%>
