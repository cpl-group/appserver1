...
<%	
	...
	objWorkBook.SaveCopyAs("\\2012dc\web_folders\finance\"  & ctime & "MeterChargeCount.xlsx")
	...
	strFilename = "\\2012dc\web_folders\finance\"  & ctime & "MeterChargeCount.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="http://appserver1.genergy.com/eri_TH/finance/<%=ctime%>MeterChargeCount.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>MeterChargeCount.xlsx</b></a> 
	</p>
	<%
	Else
	%>
