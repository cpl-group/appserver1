...
' Header Columns	
	...
	objWorkBook.SaveCopyAs("\\2012dc\web_folders\finance\"  & building & Billyear  & Billperiod  & UtilityId & "MeterLetter.xlsx")
	...
	strFilename = "\\2012dc\web_folders\finance\" & building & Billyear  & Billperiod  & UtilityId & "MeterLetter.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="http://appserver1.genergy.com/eri_TH/finance/<%=building%><%=billyear%><%=billperiod%><%=UtilityId%>MeterLetter.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=building%>MeterLetter.xlsx</b></a> 
	</p>
	<%
	Else
	%>
