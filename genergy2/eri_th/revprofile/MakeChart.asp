...
<%
dim date1, date2, bldg, pid, utype
...
dim bname
if trim(bldg)<>"" then
  rst2.open "SELECT strt from buildings WHERE bldgNum='"& bldg &"'", getLocalConnect(bldg)
...
for i = 1 to 12
	...
	objChart.AddData ArrDataSeriesUnreportedExp(i), 1, , RGB(150,0,0)
...
if trim(date2)<>"" then
  ...
  elseif trim(pid)<>"" then
	...
	objChart.ChartArea(2).SetPosition 40,180,460,300
	objChart.ChartArea(3).SetPosition 50,180,470,300
