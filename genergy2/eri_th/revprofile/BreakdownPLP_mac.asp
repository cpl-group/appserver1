...
<%
dim date1, date2, bldg, utype, pid, adjtype
...
'response.write "exec sp_RevProfile "& b&","& utype&","& date1&", 0, 0, 0, 0, 0, "&mac&", "&plp&", 0, "&session("pid")
'response.end
cnn1.test bldg, utype, date1, 0, 0, 0, 0, 0, mac, plp, 0, session("pid"), rst1
