...
dim AdminFee, TenantRate, AddonFee, ModifyRate, Coincident, CoinWithPeak, FullOnPeak, procname, customsrc, calcIntPeak, acctid, use_acctid, billnote, shadow, ticketcount, masterticketid,opentickets, criticalopentickets, totaltickets
if trim(lid)<>"" then
