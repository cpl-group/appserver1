...
<body>
<FORM action="groupSaveG1.asp" method="get">
...
<input type="button" value="Cancel" onclick="document.location='groupviewG1.asp?pid=<%=pid%>&bldg=<%=bldg%>';" class="standard" style="border:1px outset #ddffdd;background-color:ccf3cc;">
</div>
</FORM>
</body>
</html>
