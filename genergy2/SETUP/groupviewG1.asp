...
{	document.location = 'groupEditG1.asp?pid=<%=pid%>&bldg=<%=bldg%>&tid=<%=tid%>&groupname='+groupname;
}
</script>
...
<tr bgcolor="#3399cc">
  ...
  Manage Groups | <span style="font-weight:normal;"><%=breadcrumbtrail%></span>
   ...
   <td align="right"><button id="qmark2" onclick="openCustomWin('help.asp?page=groupviewG1','Help','width=400,height=500,scrollbars=1')" style="cursor:help;color:#339933;text-decoration:none;height:20px;background-color:#eeeeee;border:1px outset;color:009900;margin-left:4px;" class="standard">(<b>?</b>) Quick Help</button></td>
</tr>
<tr bgcolor="#eeeeee">
  <td><b>Groups</b></td>
