...
<%' TT 6/19/2008 This is an altered version on buildingedit.asp in order to eliminate full portfolio drop down option and jump to option.  %>
...
<% end if %>
//  }
  document.location.href = 'tenanteditG1.asp?pid=<%=pid%>&bldg=<%=bldg%>&tid='+tid;
}

function billperiodView()
{	document.location.href = 'billPeriodViewG1.asp?pid=<%=pid%>&bldg=<%=bldg%>';
}
...
/*--remove this block of code to eliminate jump to option. MT
function JumpTo(url){
...
<form name="form2" method="post" action="buildingsaveG1.asp">
  <table width="100%" border="0" cellpadding="3" cellspacing="0">
      ...
      <td> <table border=0 cellpadding="0" cellspacing="0" width="100%">
          <tr> 
            <td width="53%"> <span class="standardheader"> 
              <%if trim(bldg)<>"" then%>
              Update Building | <span style="font-weight:normal;"><a href="portfolioeditG1.asp?pid=<%=pid%>" style="color:#ffffff;"><%=portfolioname%></a> 
              &gt; <%=bldgname%></span> 
              <%else%>
              Add New Building | <span style="font-weight:normal;"><a href="portfolioeditG1.asp?pid=<%=pid%>" style="color:#ffffff;"><%=portfolioname%></a> 
              <%end if%>
              </span> </td>
    ...
    <tr bgcolor="#eeeeee"> 
      ...
      <td><input type="Checkbox" name="submetered" value="1"></td>
          ...
          <tr> 
            ...
            <td><input type="text" name="bldgname" value="<%=bldgname%>">&nbsp;Offline&nbsp;<input type="checkbox" name="offline" <%if isBuildingOff(bldg) then%>onclick="if(this.checked){document.all['updatebutton'].style.display='none';}else{document.all['updatebutton'].style.display='inline';}"<%end if%> value="1" <%if "True"=offline then response.write "CHECKED"%>></td>
            <td width="30">&nbsp;</td>
    ...
    loop %>
          ...
          <tr bgcolor="#eeeeee"> 
            ...
            <td colspan="4"> 
              ...
              <input id="updatebutton" type="submit" name="action" value="Update" class="standard" style="border:1px outset #ddffdd;background-color:ccf3cc;<%if isBuildingOff(bldg) then%>display:none<%end if%>"> 
        ...
        <table border="0" cellpadding="3" cellspacing="0">
          <tr valign="top"> 
            <td> 
			  ...
			  <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="javascript:document.location='groupViewG1.asp?pid=<%=pid%>&bldg=<%=bldg%>'" class="mgmtlink">Manage building groups</a><br>
			  <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="javascript:document.location='contactViewG1.asp?pid=<%=pid%>&bldg=<%=bldg%>'" class="mgmtlink">Manage building contacts</a><br>
    ...
    %>
             ...
             <td width="8">&nbsp;</td>
            <td><img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="open('/genergy2/eri_th/meterservices/MeterMaintenanceLetter.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no');" class="mgmtlink">Maintenance Letter</a><br> </td>
          </tr>
        </table>
        <% 
rst1.close
