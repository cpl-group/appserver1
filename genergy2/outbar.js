document.write("<DIV id='OutlookLikeBar' style='position:absolute;top:"+OB_Top+";left:"+OB_Left+";width:"+OB_Width+";height:"+OB_Height+";border:"+OB_BorderWidth+" "+OB_BorderStyle+" "+OB_BorderColor+";background:url(images/icons/bkgd.gif);background-color:"+OB_BackgroundColor+";z-index:0;visibility:hide;clip:rect(0,"+OB_Width+","+OB_Height+",0)'>");
...
function showbar(){
document.all['OutlookLikeBar'].style.visibility='show';
}
