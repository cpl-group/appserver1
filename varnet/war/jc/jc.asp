...
<tr style="font-family:arial; font-size:12; color:black" bgcolor="#0099FF">
  ...
  <td style="font-size:10" rowspan="2" align="center"> 
    ...
    <table width="95%" border="1">
      ...
      <tr> 
        <td width="14%" bgcolor="#FF66FF"><a href=<%="javascript:time('" & c & "','" & rs("job") & "')"%>>Current Hours</a></td>
        <td width="28%">
          <div align="right">
          <%=formatnumber(rs("hours"),2)%></div></td>
        <td width="16%" bgcolor="#33FFCC">Labor Hours</td>
		
        <td width="15%" bgcolor="#FFFFFF"> 
          <div align="right"><%=formatnumber(rs("jtd_labor_units"),2)%> 
          </div>
        </td>
        <td width="17%" bgcolor="#33FFCC">AVG Labor cost/h</td>
        <td width="10%" bgcolor="#FFFFFF"> 
          <div align="right">
          <%=formatcurrency(avg,2)%></div></td>
      </tr>
      <tr> 
        <td width="14%" bgcolor="#FF66FF">&nbsp;</td>
        <td width="28%">&nbsp;</td>
        <td width="16%" bgcolor="#33FFCC">Labor Cost</td>
		
        <td width="15%" bgcolor="#FFFFFF"> 
          <div align="right">
          <%=formatcurrency(rs("jtd_labor_cost"),2)%></div></td>
      ...
      <tr> 
        <td width="14%" bgcolor="#FF66FF">&nbsp;</td>
        <td width="28%">&nbsp;</td>
        <td width="16%" bgcolor="#33FFCC">Overhead Cost</td>
		
        <td width="15%" bgcolor="#FFFFFF"> 
          <div align="right"><%=formatcurrency(rs("jtd_overhead_cost"),2)%> 
          </div>
        </td>
        <td width="17%" bgcolor="#33FFCC">&nbsp;</td>
        <td width="10%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr> 
        <td width="14%" bgcolor="#FF66FF">&nbsp;</td>
        <td width="28%">&nbsp;</td>
        <td width="16%" bgcolor="#33FFCC">Burden Cost</td>
		
        <td width="15%" bgcolor="#FFFFFF"> 
          <div align="right"><%=formatcurrency(rs("jtd_other_cost"),2)%> 
          </div>
        </td>
        <td width="17%" bgcolor="#33FFCC">&nbsp;</td>
        <td width="10%" bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <tr> 
        <td width="14%" bgcolor="#FF66FF">Projected Cost</td>
        <td width="28%"><div align="right"><b><%=formatcurrency(tcost,2)%> 
          </b></div></td>
        <td width="16%" bgcolor="#33FFCC">JTD Cost</td>
		
        <td width="15%" bgcolor="#FFFFFF"> 
          <div align="right"><b><%=formatcurrency(rs("jtd_cost"),2)%> 
          </b></div>
        </td>
        <td width="17%" bgcolor="#33FFCC">&nbsp;</td>
        <td width="10%" bgcolor="#FFFFFF">&nbsp;</td>
