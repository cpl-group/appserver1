...
%>
    ...
    <table width="99%" border="0">
      <tr>
        <td width="9%" height="20"> <%=rs("date")%> </td>
        <td width="50%" height="20"> <%=left(rs("description"),55)%> </td>
        <td align="right" width="11%" height="20"> 
          <div align="right"> <%=formatnumber(rs("hours"),2)%> </div>
        </td>
        <td align="right" width="9%" height="20"><%=formatnumber(rs("overt"),2)%></td>
        <td align="right" width="2%" height="20">&nbsp;</td>
        <td align="left" width="19%" height="20"><%=rs("matricola")%></td>
        <%
 rs.movenext
