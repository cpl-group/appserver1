              ...
              <table width="100%" border="0">
                <tr> 
                  <td bgcolor="#339999" width="20%"> 
                    <div align="center"><b><a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#1" target="list"><%=Categorys(5)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#1" target="list"><%=Categorysbh(5)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#1" target="list"><%=Categorysot(5)%></a> 
                      </b></div>
                  </td>
                  <td bgcolor="#00FF00" width="20%"> 
                    <div align="center"><b><a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#1" target="list"><%=Categorys(1)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#1" target="list"><%=Categorysbh(1)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#1" target="list"><%=Categorysot(1)%></a></b></div>
                  </td>
                  <td bgcolor="#00CC00" width="20%"> 
                    <div align="center"><b><a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#2" target="list"><%=Categorys(2)%> 
                      | <%=Categorysbh(2)%> | <%=Categorysot(2)%></a></b></div>
                  </td>
                  <td bgcolor="#3399CC" width="20%"> 
                    <div align="center"><b><a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#3" target="list"><%=Categorys(3)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#3" target="list"><%=Categorysbh(3)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#3" target="list"><%=Categorysot(3)%></a></b></div>
                  </td>
                  <td bgcolor="#FF0000" width="20%"> 
                    <div align="center"><b><a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#4" target="list"><%=Categorys(4)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#4" target="list"><%=Categorysbh(4)%></a> 
                      | <a href="corpinvoicedetail.asp?day=<%=flag%>&job=<%=job%>&description=<%=description%>#4" target="list"><%=Categorysot(4)%></a></b></div>
                  </td>
                </tr>
                <tr> 
                  <td bgcolor="#339999" width="20%"> 
