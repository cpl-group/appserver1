...
function checkpercent(percentcomp) {
	if ((percentcomp <= 0) || (percentcomp>100)){
	 	alert("Percent Complete is invalid, please double check.")
	}
...
sqlstr = "select Distinct customers.companyname, [employees].[First Name] + ' ' + [employees].[Last Name] AS projmanager, [job log].[entry type],[job log].* ,case when [job log].[entry id] > 6283 then left([entry type],2)+'-00'+convert(varchar(4),[entry id]) else '00-00'+convert(varchar(4),[entry id]) end as  tjob from employees join [job log] on (employees.id=[job log].manager) join customers on ([job log].customer=customers.customerid ) where [entry id]=" & job
      ...
      <table width="100%" border="0">
        <tr> 
            ...
            <td height="2" width="29%"><i><b><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"> 
			  ...
			  str="select sum(po_total) as sum1 from po where jobnum=" & job & " and accepted = 1"
            ...
            <td height="2" width="30%"><i><b><font color="#FFFFFF" face="Arial, Helvetica, sans-serif"> 
			  ...
			  str="select sum(hours) as sum1 from invoice_submission where jobno=" & job & " and submitted=1"
      ...
      <div align="left"> 
        <table width="100%" border="0">
          ...
          <tr> 
			  ...
			  str4="SELECT [Type ID]FROM [Genergy Entry Types]where job=1 ORDER BY [Type ID] "
			  ...
			  str5="select jobtype from jobtypes "
        ...
        <table width="100%" border="0">
          ...
          <tr> 
			  ...
			  str9="select distinct status from status where job=1 order by status desc"
			  ...
			  rst9.close%>
				...
				<td width="35%"><font face="Arial, Helvetica, sans-serif">				
				<input type="text" name="percentcomp" value="<%=rst1("% completed")%>"  onchange="checkpercent(this.value)">
                </font></td>
              <td width="22%"> <font face="Arial, Helvetica, sans-serif"> 
    ...
    <td height="2"> 
      <div align="left"> 
        <table width="100%" border="0">
          ...
          <tr> 
              <td width="35%"> <font face="Arial, Helvetica, sans-serif"> <%=rst1("companyname")%></font></td>
		 ...
		 <table width="100%" border="0">
            <tr bgcolor="#CCCCCC"> 
              <td width="21%"><font face="Arial, Helvetica, sans-serif">Type:</font></td>
              <td width="24%"><font face="Arial, Helvetica, sans-serif">Contact 
                Name:</font></td>
              <td width="25%"><font face="Arial, Helvetica, sans-serif">Customer 
                Phone #</font></td>
            ...
            <tr> 
              <td width="21%" height="32"> <font face="Arial, Helvetica, sans-serif">Please 
