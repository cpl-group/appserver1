...
<table width="100%" border="0" height="6%" cellspacing="0">
  <tr bgcolor="#3399CC">
    <td width="100%" ><i><font face="Georgia, Times New Roman, Times, serif" size="+1">
      <div align="center">Job No. <%=job%> 
        Invoice date: <%=flag%></div></i></font>
    </td>
	<td><div align="right">
<input type="button" name="Submit" value="Back" onclick="javascript:history.back()">
</div></td>
</tr></table><br>
<i><font face="Georgia, Times New Roman, Times, serif" size="+1">
	<%=description%>
</font></i>
