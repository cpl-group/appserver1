...
<table width="100%" border="0">
  <tr> 
    <td bgcolor="#3399CC"> 
      <div align="center"><font color="#FFFFFF"><b><font face="Arial, Helvetica, sans-serif">PO 
  ...
  <tr>
    <td width="48%" height="2"> 
      <input type="button" name="Button" value="Approve / Reject PO's" onClick="Javascript:frames.poadmin.location='corppoview.asp'">
      <input type="button" name="Button2" value="Approved PO's" onClick="Javascript:frames.poadmin.location='acctpoview.asp'">
    </td>
    <td width="52%" height="2"> 
      <div align="right">
        <input type="button" name="Submit" value="Print Current View" onClick='javascript:document.frames.poadmin.focus();document.frames.poadmin.print()'>
      </div>
    </td>
  </tr>
</table>
<p><IFRAME name="poadmin" width="100%" height="100%" src="null.htm" scrolling="auto" marginwidth="0" marginheight="0" ></IFRAME></p>
</body>
</html>