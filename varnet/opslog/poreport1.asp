...
sqlstr = "select po.*,ltrim(str(po.jobnum))+'.'+ltrim(str(po.ponum)) as pono,p.* ,(p.qty*p.unitprice) as ptotal, p.description as d from po join po_item as p on PO.id=p.poid where PO.id='"&po&"'"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td> 
      <div align="center"><b><font face="Arial, Helvetica, sans-serif">Invoice 
        Number</font></b></div>
    </td>
  </tr>
  <tr> 
    ...
    <td><div align="center"><%=rst1("jobnum")%></div></td>
    <td><div align="center"><%=rst1("ponum")%></div></td>
    <td><div align="center"><%=rst1("invnum")%></div></td></font>
  </tr>
</table>
<hr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td width="88%"> 
      <div align="right"><font face="Arial, Helvetica, sans-serif"><b>SubTotal: 
        </b></font></div>
    </td>
    <td width="12%"><%=FormatCurrency(subt)%></td>
  </tr>
   <tr> 
    <td width="88%"> 
      <div align="right"><font face="Arial, Helvetica, sans-serif"><b>Tax: </b></font></div>
    </td>
    <td width="12%">$<%=(tax1)%></td>
  </tr>
   <tr> 
