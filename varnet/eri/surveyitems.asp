...
function delete1(key,surveyid){
	if(confirm("Delete survey item?")){
	document.location="deleteitem.asp?key="+key+"&surveyid="+surveyid}
	}
  ...
  <tr> 
    <form name=form1 method="post" action="itemsupdate.asp">
      ...
      <td width=29> 
        ...
        <input type="text" name="qty" value="<%=rst1("qty") %>" size="3" onChange="setValue(<%=count%>)" maxlength="3" >
        </font>
      </td>
      <td width=146> 
        <font face="Arial" size="1"> 
      ...
      <td width="68"> 
        <div align="center">
          <input type="Submit" name="Submit" value="Update"><font face="Arial, Helvetica, sans-serif" size="1"><a href="javascript:delete1('<%=rst1("id")%>','<%=rst1("surveyid")%>')"><img src="delete.gif" border="0"> </a> </font></div>
...
%>
  <tr> 
    <form name="form2" method="post" action="itemsadd.asp">
	  ...
	  <a tabindex=0>
        <font face="Arial" size="1">
        <input type="text" name="qty" value="0" size="3" onChange="setValue(<%=count%>)" maxlength="3">
        </font>
		</a>
      </td>
      <td width=146> 
