...
//alert(c)
	...
	//if(c==2){
		...
		window.location="http://www.genergyonline.com"
        //window.close()
	//}
	if (self.closed) {
		alert("ok")
...
<p align="left">&nbsp;</p>
<div align="right"><IFRAME name="app" width="100%" height="100%" src="main.asp" scrolling="auto" marginwidth="0" marginheight="0" ></IFRAME> 
</div>
</body>
</html>
