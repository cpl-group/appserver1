...
%>
    ...
    level3ID = theMenu.addChild(level2ID, "Document", "ERI Management Profile", "<%Response.Write(userdetails("eri_link"))%>", "");
            ...
            %>             
    level3ID = theMenu.addChild(level2ID, "Document", "Power Grid Identification", "<%Response.Write(userdetails("pgi_link"))%>", "");
            <%
                    end if
...
if (self.name == 'menu') {
	...
	if (floatingMode) {
		...
		self.document.writeln('<frame name="menu" src="menu3t.htm" scrolling="auto" marginwidth="1" marginheight="1">');
