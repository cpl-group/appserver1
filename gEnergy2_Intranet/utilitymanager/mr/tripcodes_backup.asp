...
sqlstr = "select tripcode, a.bldgnum, strt,utility, utilityid from " & sqltemp & " a inner join dbo.super_tripcodes s on a.bldgnum = s.bldgnum inner join  dbo.tblutility u on s.uid = u.utilityid order by tripcode, a.bldgnum" 
