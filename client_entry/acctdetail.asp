...
dim lmep, unitcredit, TDsalesamt, MACdollar, EscoSTdollar, fueladjdollar, TDwithfuel, TDtotalcalc
...
<td><%if Escoref<>"0" then%>MAC&nbsp;<input type="checkbox" name="TDwithmac" value="1" onclick="calcTDTotalAmt()" <%if trim(TDwithmac)="1" then response.write " CHECKED"%>><span style="font-size:10">&nbsp;include</span><%else%>Full&nbsp;Service&nbsp;Fuel&nbsp;<input type="checkbox" name="TDwithfuel" value="1" onclick="calcTDTotalAmt()" <%if trim(TDwithfuel)="1" then response.write " CHECKED"%>><span style="font-size:10">&nbsp;include</span><%end if%></td><td>$</td>
<td><%if Escoref<>"0" then%><input type="text" name="MACdollar" value="<%=MACdollar%>" onKeyUp="calcTDTotalAmt();checkvalues();">&nbsp;Rate&nbsp;$&nbsp;<input type="text" name="MAC" value="<%=MAC%>" onKeyUp="calcfueladjSub();calcTDTotalAmt();checkvalues();"><%else%><input type="text" name="fueladjdollar" value="<%=fueladjdollar%>" onKeyUp="calcTDTotalAmt();checkvalues();">&nbsp;Raw&nbsp;%&nbsp;<input type="text" name="fueladjustmentSub" value="<%=fueladjustmentSub%>" onKeyUp="checkvalues();"><input type="hidden" name="MAC" value="<%=MAC%>" onKeyUp="calcfueladjSub();checkvalues();"><%end if%></td>
</tr>
...
<td>Sales&nbsp;Tax&nbsp;<input type="checkbox" name="TDwithtax" value="1" onclick="calcTDTotalAmt();"<%if trim(TDwithtax)="1" then response.write " CHECKED"%>><span style="font-size:10">&nbsp;include</span></td><td>$</td>
<td><input type="text" name="TDsalesamt" value="<%=TDsalesamt%>" onKeyUp="calcTDTotalAmt();checkvalues();">&nbsp;Raw&nbsp;%&nbsp;<input type="text" name="TDsalestax" value="<%=TDsalestax%>" onKeyUp="checkvalues();"></td>
</tr>
...
<td><input type="text" name="TDtotalamt" value="<%=TDtotalamt%>" onChange="noCalcTDTotalAmt=1;" onKeyUp="calcTDgrt(i);calcTotalBillAmt();checkvalues();"></td>
</tr>

<tr>
<td>T&nbsp;&amp;&nbsp;D Unit Cost KW</td><td>$</td>
<td><input type="text" name="TDunitcostkw" value="<%=TDunitcostkw%>" onKeyUp="checkvalues();"></td>
<td>Calculate Total</td><td></td>
<td><input name="TDtotalcalc" value="1" onclick="calcTDTotalAmt()" type="radio"<%if trim(TDtotalcalc)="True" or trim(TDtotalcalc)="" then response.write " CHECKED"%>>Yes&nbsp;<input name="TDtotalcalc" value="0" onclick="calcTDTotalAmt();" type="radio"<%if trim(TDtotalcalc)="False" then response.write " CHECKED"%>>No</td>
</tr>
