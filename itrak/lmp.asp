...
<tr><td width="565" bgcolor="#000000"> 
        ...
        <tr><td width="100%" height="2" bgcolor="#000000">
                ...
                <tr><td><b><font size="2" face="Arial, Helvetica, sans-serif" color="#FFFFFF">
                        <div id="lmpnav" style="visibility:visible;position:relative;left:0;top:0;">
                            ...
                            <a href="javascript:lmpmoveprev()" style="text-decoration:none;" onMouseOver="this.style.color='lightblue';hoverHelp('prevhelp')" onMouseOut="this.style.color='white';HideHelp('prevhelp')">Previous Day</a> | 
                            <a href="javascript:lmpmovenext()" style="text-decoration:none;" onMouseOver="this.style.color='lightblue';hoverHelp('nexthelp')" onMouseOut="this.style.color='white';HideHelp('nexthelp')">Next Day</a> | 
                            <a href="javascript:lmpnow()" style="text-decoration:none;" onMouseOver="this.style.color='lightblue';hoverHelp('tdayhelp')" onMouseOut="this.style.color= 'white';HideHelp('tdayhelp')">Go To Today</a>
                        </div>
...
<div id="lmptabs" style="visibility:visible;position:relative;left:0;top:0;">
	<table width="565" border="0" cellspacing="0" cellpadding="0" align="center"  style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; font-weight: bold; text-decoration:none;">
	<tr>
		<td id="tab1" width="5%" style="background-color:#0099FF">&nbsp;<a href="javascript:loadchart()" onclick="settabs(document.all['tab1']);document.forms['form1'].zoom.value='100';" onMouseOver="this.style.color='black';" onMouseOut="this.style.color='white';" style="color:white">Hourly&nbsp;Intervals</a>&nbsp;</td>
		<td id="tab2" width="5%" style="background-color:#CCCCCC">&nbsp;<a href="javascript:loadchart()" onclick="settabs(document.all['tab2']);document.forms['form1'].zoom.value='1';" onMouseOver="this.style.color='black';" onMouseOut="this.style.color= 'white';" style="color:white">15&nbsp;Minute&nbsp;Intervals</a>&nbsp;</td>
		<td id="tab3" width="5%" style="background-color:#CCCCCC">&nbsp;<a href="javascript:loadcalendar()" onclick="settabs(document.all['tab3']);" onMouseOver="this.style.color='black';" onMouseOut="this.style.color= 'white';" style="color:white"></a>&nbsp;</td>
		<td  width="85%" align="right">&nbsp;</td>
	</tr></table>
</div>

<table width="565" border="0" cellspacing="0" cellpadding="0" height="270" align="center">
<tr><td height="270"><iframe src="<%=IFrame1%>" name="lmp" id="lmp" width="100%" height="100%" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
</table>
<table width="565" border="0" cellspacing="0" cellpadding="0" align="center" height="250">
  <tr><td><iframe name="dataset" width="100%" height="100%" src="<%=IFrame2%>" scrolling="auto" marginwidth="0" marginheight="0" style="border: 2px solid #0099FF;"></iframe></td></tr>
</table>
