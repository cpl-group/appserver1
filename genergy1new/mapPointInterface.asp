...
<body>
<img onclick="newPoint(document.body.scrollLeft+event.x-2, document.body.scrollTop+event.y-2);parent.newpoint(document.body.scrollLeft+event.x-2, document.body.scrollTop+event.y-2);" style="position:absolute; left:0; top:0" id="map" src="<%=mapref%>" border="0">
