...
cnn1.Open getLocalConnect(getKeyValue("bldg"))
...
%>
        <tr bordercolor="#FFFFFF"> 
          ...
          <td width="12%" height="1%" align="center" bordercolor="#FFFFFF"> 
            <p align="right"><font size="1" face="Arial, Helvetica, sans-serif"><%=Formatnumber(rst1("used"),0)%> 
              </font> 
          </td>
...
tot_kwhused= tot_kwhused + rst1("used")
